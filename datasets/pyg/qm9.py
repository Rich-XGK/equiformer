...
conversion = torch.tensor(
    [1.0, 1.0, HAR2EV, HAR2EV, HAR2EV, 1.0, HAR2EV, HAR2EV, HAR2EV, HAR2EV, HAR2EV, 1.0, KCALMOL2EV, KCALMOL2EV, KCALMOL2EV, KCALMOL2EV, 1.0, 1.0, 1.0]
)
...
class QM9(InMemoryDataset):
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            data = Data(
                x=x, pos=pos, z=z, edge_index=edge_index, edge_attr=edge_attr, y=y, name=name, index=i, edge_d_index=edge_d_index, edge_d_attr=edge_d_attr
            )
